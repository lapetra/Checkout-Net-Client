namespace Checkout
{
    public class ApiUrls
    {
        ...
        //ShoppingList Uris
        private static string _shoppingListAddItem;
        private static string _shoppingListUpdateItem;
        private static string _shoppingListGetItem;
        private static string _shoppingListDeleteItem;
        private static string _shoppingListGetAll;
        ...
        public static void ResetApiUrls()
        {
            ...
            _shoppingListAddItem = null;
            _shoppingListUpdateItem = null;
            _shoppingListGetItem = null;
            _shoppingListDeleteItem = null;
            _shoppingListGetAll = null;
        }
