...
namespace Tests
{
    public class TestHelper
    {
        ...
        public static BaseItem GetShoppingListBaseItemModel()
        {
            Random rnd = new Random();

            return new BaseItem()
            {
                Name = RandomData.ItemName,
                Quantity = rnd.Next(0, 999)
            };
        }

        public static BaseItem GetShoppingListBaseItemModel(string Name)
        {
            Random rnd = new Random();
